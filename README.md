# TeamSpeak 3 PHP Framework [![Build Status](https://travis-ci.org/ronindesign/ts3phpframework.svg?branch=testing "Travis CI Build Test Status")](https://travis-ci.org/ronindesign/ts3phpframework/branches) [![Coverage Status](https://coveralls.io/repos/github/thhan/ts3phpframework/badge.svg?branch=master)](https://coveralls.io/github/thhan/ts3phpframework?branch=master)
